...
export function AdmissionDetailPage({ admission }: { admission: AdmissionDetail }) {
  ...
  return (
    <div className="px-gutter py-4 pb-24 lg:max-w-content-full lg:mx-auto space-y-4">
      ...
      {/* 1-column on mobile, 2-column on lg (좌 sticky meta, 우 detail) */}
      <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,320px)_minmax(0,1fr)] lg:gap-8 lg:items-start space-y-4 lg:space-y-0">
        {/* 좌측 — 요약 + 스펙 (lg sticky) */}
        ...
        {/* 우측 — 활동/에세이/hook/AI 분석 (Elite) 또는 lock CTA */}
