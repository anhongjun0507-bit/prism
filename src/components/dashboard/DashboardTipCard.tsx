  ...
  return (
    ...
    >
      <button
        ...
        onClick={dismiss}
        aria-label="안내 닫기"
        className="absolute top-1 right-1 w-11 h-11 rounded-full hover:bg-foreground/5 flex items-center justify-center text-muted-foreground hover:text-foreground transition-colors"
      >
