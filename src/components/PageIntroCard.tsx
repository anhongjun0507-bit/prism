  ...
  return (
    ...
    >
      <button
        ...
        onClick={dismiss}
        aria-label="안내 닫기"
        className="absolute top-3 right-3 w-8 h-8 rounded-full hover:bg-foreground/5 flex items-center justify-center text-muted-foreground hover:text-foreground transition-colors"
      >
