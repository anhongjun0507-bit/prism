...
/**
 * PRISM Dialog — Radix Dialog primitive 기반.
 * 가이드 §글로벌 UI: max-w-420 / radius-lg / 백드롭 rgba(0,0,0,.5).
 */
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid w-full max-w-[420px] -translate-x-[50%] -translate-y-[50%] gap-4 rounded-lg border border-border bg-card p-6 text-card-foreground shadow-prism-md",
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
        "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
